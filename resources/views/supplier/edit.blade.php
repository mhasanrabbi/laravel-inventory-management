            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit {{ $supplier->name}}</h4><br/>
                        ...
                        <form method="POST" action="{{ route('supplier.update') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input  value="{{ $supplier->mobile_no }}" name="mobile_no" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Email</label>
                                <div class="form-group col-sm-10">
                                    <input  value="{{ $supplier->email }}" name="email" class="form-control" type="email">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Address</label>
                                <div class="form-group col-sm-10">
                                    <input  value="{{ $supplier->address }}" name="address" class="form-control" type="text">
                                </div>
                            </div>
